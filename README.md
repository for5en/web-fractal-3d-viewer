...
* **Juliabulb Explorer**: Real-time manipulation of fractal parameters.
* **Responsive Design**: Rendering resolution scales automatically to the browser window.

## 🛠️ Tech Stack
* **Vite** - Lightning-fast build tool
* **Three.js** - WebGL framework
* **GLSL** - Shader language for fractal calculations
